...
let mockedReligionPlaces = null

beforeEach(() => {
    mockedTab = new MockedTab()
    mockedAddress = new MockedAddress()
    mockedReligionPlaces = new MockedPlaces()
...
describe("when the main component food-popup has been rendered", () => {
    ...
    it("should show the food popup", async () => {
        ...
        mockedReligionPlaces.mockGoodAPI(mockFetch)

        await act(async () => { fireEvent.change(topicMenuSelect, { target: { value: "Religion" } }) });

        const foodPopup = screen.getByTestId("religion-popup")
    ...
    it("should show the food popup even if empty food api response", async () => {
        ...
        const topicMenuSelect = screen.getByTestId("topic_menu_input") as HTMLSelectElement
        mockedReligionPlaces.mockBadEmptyAPI(mockFetch)
    ...
    it("should show the food popup even if empty food api invalid", async () => {
        ...
        const topicMenuSelect = screen.getByTestId("topic_menu_input") as HTMLSelectElement
        mockedReligionPlaces.mockBadInvalidAPI(mockFetch)
